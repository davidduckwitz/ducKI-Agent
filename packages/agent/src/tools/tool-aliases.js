...
export const TOOL_ALIAS_MAP = new Map(TOOL_ALIAS_TABLE.flatMap((entry) => entry.aliases.map((alias) => [alias, entry.canonicalTool])));
export const TOOL_ACTION_ALIAS_MAP = {
    filesystem: {
        readfile: "read",
        read_file: "read",
        writefile: "write",
...
export function resolveToolAction(toolName, action) {
